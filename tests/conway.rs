...
fn adding_a_cell() {
    ...
    c.add(Cell::alive(), &Location::new(0, 0));
...
fn cell_with_no_neigbors_dies() {
    let mut c = Conway::new(1);
    c.add(Cell::alive(), &Location::new(2, 0));
...
fn cell_with_one_neighbor_dies() {
    let mut c = Conway::new(1);
    c.add(Cell::alive(), &Location::new(2, 0));
    c.add(Cell::alive(), &Location::new(3, 0));
...
fn cell_with_two_neighbors_lives() {
    ...
    c.add(Cell::alive(), &Location::new(2, 0));
    c.add(Cell::alive(), &Location::new(3, 0));
    c.add(Cell::alive(), &Location::new(4, 0));
...
fn stable_block() {
    ...
    c.add(Cell::alive(), &Location::new(2, 1));
    c.add(Cell::alive(), &Location::new(3, 1));
    c.add(Cell::alive(), &Location::new(2, 2));
    c.add(Cell::alive(), &Location::new(3, 2));
    let expected = "OOOOOOOOOOOOOOOOOOOO\n".to_string() +
...
fn stable_beehive() {
    ...
    c.add(Cell::alive(), &Location::new(2, 1));
    c.add(Cell::alive(), &Location::new(3, 1));
    c.add(Cell::alive(), &Location::new(1, 2));
    c.add(Cell::alive(), &Location::new(4, 2));
    c.add(Cell::alive(), &Location::new(2, 3));
    c.add(Cell::alive(), &Location::new(3, 3));
    let expected = "OOOOOOOOOOOOOOOOOOOO\n".to_string() +
                   "OOXXOOOOOOOOOOOOOOOO\n" +
...
fn stable_loaf() {
    ...
    c.add(Cell::alive(), &Location::new(4, 2));
    c.add(Cell::alive(), &Location::new(2, 3));
    c.add(Cell::alive(), &Location::new(4, 3));
    c.add(Cell::alive(), &Location::new(3, 4));
    let expected = "OOOOOOOOOOOOOOOOOOOO\n".to_string() +
                   "OOXXOOOOOOOOOOOOOOOO\n" +
                   "OXOOXOOOOOOOOOOOOOOO\n" +
...
fn oscillating_toad() {
    ...
    c.add(Cell::alive(), &Location::new(3, 2));
    c.add(Cell::alive(), &Location::new(4, 2));
    c.add(Cell::alive(), &Location::new(1, 3));
    c.add(Cell::alive(), &Location::new(2, 3));
    c.add(Cell::alive(), &Location::new(3, 3));
    let period_one = "OOOOOOOOOOOOOOOOOOOO\n".to_string() +
                     "OOOOOOOOOOOOOOOOOOOO\n" +
